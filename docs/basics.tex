...
\subsection{Dedups and Normalize}
...
The best way to work with \lstinline{DEDUP} is to first sort your data before feeding it to DEDUP. 
...
\lstinputlisting[caption={(P4) Deduplications and Normalize}]{../source/27-nth.ecl}
...
\subsubsection{(P) Fibonacci numbers}
