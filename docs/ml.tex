...
\lstinputlisting[caption={Install LinearRegression Bundle}]{../source/ml/linreg/install.sh}
...
\lstinputlisting[caption={Install Logistic Regression Bundle}]{../source/ml/logreg/install.sh}
